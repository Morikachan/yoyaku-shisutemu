...
<body id="body">
    ...
    <main id="main">
        ...
        <div class="content-container">
            <form action="./inquirySend.php" method="POST" enctype="multipart/form-data">
                <h3>メールアドレスを入力してください</h3>
                <input type="email" name="inquiryEmail" value="">
                <h3>画像がある場合は以下から添付してください</h3>
                <input type="file" name="avatar" accept=".png, .jpg, .jpeg, .pdf, .doc" multiple>
                <h3>お問い合わせ詳細</h3>
